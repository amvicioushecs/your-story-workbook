  ...
  return <div className="min-h-screen pb-20">
      ...
      <div className="wood-texture text-center py-12 px-4 mb-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-crafted-cream opacity-70 mt-2 italic">By {{User_Profile}}</p>
        </div>
      </div>
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-8 relative">
          ...
          <div className="hidden lg:block absolute left-0 z-10" style={{
          left: sidebarOpen ? "calc(25% - 16px)" : "-8px"
        }}>
